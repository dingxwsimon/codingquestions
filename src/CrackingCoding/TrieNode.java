...
public class TrieNode {
     ...
     * 
     * Using a LinkedList will take less space than an array, since we allocate
     * no more space than necessary. Another good option would be a hash table,
    ...
    /*
     * Add the String passed in as argument to the trie, starting at a child
     * node of this node. If any prefix of this String is already present in the
     * trie starting from a child node of this node, only add the remaining part
