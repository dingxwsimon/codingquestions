...
public class SuffixTreeTest {
    ...
    public static void main(String[] args) {
        ...
        // The addPrefix() function will update this value after every new
        // prefix is
        // added.
    ...
    // at the same point in the input text. If so, it tags that suffix as
    // correct
    ...
    // as
    // well.
    // Every count in the array has the number of child edges emanating from
    // that
    // node.
    ...
    public static void validate() {
        ...
        out.println("Leaf count : " + leaf_count
                + (leaf_count == (SuffixTree.N + 1) ? " OK" : " Error!"));
    ...
    public static boolean walk_tree(int start_node, int last_char_so_far) {
        ...
        // If this node didn't have any child edges, it means we are at a leaf
        // node,
        ...
        if (edges == 0) {
            ...
            String comp = new String(SuffixTree.T, SuffixTree.N - curr.length()
                    + 1, strlen(SuffixTree.T)
                    - (SuffixTree.N - curr.length() + 1));
