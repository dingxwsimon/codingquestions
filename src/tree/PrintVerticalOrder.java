...
public class PrintVerticalOrder {
     ...
     * distance with respect to root. Iterate for each vertical line at distance
     * minimum to maximum from root. This solution is O(n2), because getting the
     * width of tree requires O(n) time. (Wait, is it not? Think about a
     * complete tree of 3 level and 7 nodes) O(n) solution is available using a
     * HashMap.
     */
