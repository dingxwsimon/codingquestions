...
public class DecisionTree {
    ...
    public static void main(String[] args) {
        ...
        examples[3] = new Example(example_attributes, gr_20, gr_50, gr_80, no,
                overcast, yes);
        examples[4] = new Example(example_attributes, gr_20, gr_50, gr_80, yes,
                no, yes);
        examples[5] = new Example(example_attributes, gr_20, gr_50, gr_80, yes,
                overcast, yes);
        examples[6] = new Example(example_attributes, gr_20, no, no, yes, no,
                no);
        examples[7] = new Example(example_attributes, no, no, no, no, no, no);
        examples[8] = new Example(example_attributes, gr_20, no, no, no,
                overcast, yes);
        examples[9] = new Example(example_attributes, gr_20, no, no, no,
                scattered, yes);
    ...
    public static Node<?> learnDecision(Example[] examples,
        ...
        for (Condition c : best.possible_conditions) {
            ...
            Node<?> sub_tree = learnDecision(example_i,
                    removeBest(attributes, best), label, desired_attribute);
    ...
    public static double Remain(Example[] examples, Attribute attribute,
        ...
        for (Condition major_condition : attribute.possible_conditions) {
            ...
            Example[] sub_examples = attribute.satisfied(examples,
                    major_condition);
            ...
            for (Condition c : desired_attribute.possible_conditions) {
                Example[] examples_c = desired_attribute.satisfied(
                        sub_examples, c);
    ...
    /**
     * computers the I value of Remain sum(-p(vi)logbase2ofp(vi))
     *
    ...
    public static class ExampleComparator implements Comparator<Example> {
        @Override
    ...
    public static class Node<T> {
        ...
        public String toString(String tabs) {
            ...
            return "\n" + tabs + "Node: " + identifier + " value: "
                    + data.toString() + " children: " + childs;
        }
