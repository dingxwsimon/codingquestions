...
/**
 * This class contains routines to calculate the normal cumulative distribution
 * function (CDF) and its inverse.
 *
...
public class CDF_Normal extends Object {
     ...
     * value.
     *
     * @param p p must lie between 0 and 1. xnormi returns the normal cdf
     ...
     *
     * @param z The method returns the value of the normal cumulative
