...
public class WantCandy {
    // actually the probability of "last candy is white" based on the initial
    // red
    ...
    // Probability(getting a red candy) = Probability(get a red candy in first
    // try
    // and get a red candy at the second try)
    // = (numR)^2/(numR + numW)^2

    // Probability(getting a white candy) = Probability(get a white candy in
    // first
    // try) +
