...
public class DataCenter {
    ...
    static final int NULL = -1, OPEN = 0, BLOCKED = 1, START = 2, END = 3,
            XSHIFT = 3, YMASK = (1 << XSHIFT) - 1, // SHIFT needs to be
    // increased if X
    // or Y need more than SHIFT
    // bits
    D[] = new int[]{1, -1, -(1 << XSHIFT), 1 << XSHIFT}, // deltas
    // for
    // Left,
    // Right,
    // Up, Down
    ...
    static long state; // use 64-bits to represent upto 64 cells, always make
    // sure
    ...
    static int compute(final int p) {
        ...
        try {
            ...
            if (numOfExits(end) == 0 || !isFloodFillable()) // TODO: smart
                // schedule
                // floodfills -
                // maybe more
                // later or after 3
