...
public class MinWordDistance {
    ...
    /*
     * This class will be given a list of words (such as might be tokenized from
     * a paragraph of text), and will provide a method that takes two words and
     ...
     * "quick")); assert(finder.distance("fox","the") == 3);
