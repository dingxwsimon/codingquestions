...
public class KNearestPoint {
    ...
    public interface PointsOnAPlane {
        ...
        /**
         * For given 'center' point returns a subset of 'm' stored points that
         * are closer to the center than others.
         * <p>
    ...
    public static class PointsOnAPlaneImpl implements PointsOnAPlane {
