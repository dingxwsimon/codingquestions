...
public class AllSubset {
    ...
    /*
     * public static void KSubSets( int n, int k, int depth, String SubSet, int
     * i) { if (depth == k) System.out.println(SubSet); else if (n - i + 1 >= k
     * - depth) { char[] Num = new char[128]; for (int j = i; j <= n; j++) {
