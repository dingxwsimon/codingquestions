...
public class BoxStack {
	...
	/*
	 * Create an array of all rotations of given boxes For example, for a
	 * box {1, 2, 3}, we consider three instances{{1, 2, 3}, {2, 1, 3}, {3,
	 * 1, 2}}
	 */
	Box[] rot = new Box[3 * n];
	int index = 0;
	...
	/*
	 * Sort the array ¡®rot[]¡® in decreasing order, using library function
	 * for quick sort
	 */
	...
	/*
	 * Initialize msh values for all indexes msh[i] ¨C> Maximum possible
