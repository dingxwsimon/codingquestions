...
public class ProbabilityofAlive
{
   ...
   * the island is standing at any given co-ordinates (x,y). He can move in any
   ...
   * is standing at given co-ordinates (x,y). He is allowed to move n steps on
   * the island (along the matrix). What is the probability that he is alive
   * after he walks n steps on the island?
