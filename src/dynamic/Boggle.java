...
public class Boggle {
    ...
    public static char[][] boardGen() {
        ...
        for (int i = 0; i < 16; i++) // For each dieid
        {
            ...
            } while (board[row][column] != ' '); // Runs until positrion is
            // empty
            board[row][column] = letterRoll(i); // places the die in that
            // position
    ...
    public static char letterRoll(int dieId) {
        char dice[][] = { // 2D array of 1D arrays of characters representing
                // each
    ...
    public static boolean readFromFile(String filename, String word)
        ...
        do {
            ...
            sRead = fileReader.readLine();// reads the next line in the file
            // input
            // buffer
    ...
    public static boolean moveCheck(char[][] board, String word) {
        ...
        for (int i = 1; i < word.length(); i++) {
            // Checking that the location value of each letter, excepting the
            // first,
