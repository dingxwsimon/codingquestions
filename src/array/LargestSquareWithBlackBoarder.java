...
// CC150 18.11
public class LargestSquareWithBlackBoarder {
    ...
    public static Subsquare findSquareWithSize(SquareCell[][] processed,
	    int square_size) {
    ...
    private static boolean isSquare(SquareCell[][] matrix, int row, int col,
	    int size) {
	...
	int[][] matrix = new int[][] { { 1, 0, 1, 0, 1 }, { 0, 1, 1, 1, 1 },
