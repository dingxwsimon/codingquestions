...
public class OverlapDisk {
     ...
     * i-th disc has center in (0,i) and a radius A[i]. We say that k-th disc
     * and j-th disc intersect, if and k-th and j-th discs have at least one
     * common point. Write a function which given an array A describing N discs
     * as explained above, returns the number of pairs of intersecting discs. =
     */
