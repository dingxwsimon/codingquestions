...
public class SlidingWin {
    /*
     * Input: A long array A[], and a window width w Output: An array B[], B[i]
     * is the maximum value of from A[i] to A[i+w-1] Requirement: Find a good
     * optimal way to get B[i]
     */
	...
	for (int i = 0; i < A.length; i++) {
	    ...
	    int data = A[i];
	    // if the A[i] is violating q's sequence, then remove all the
	    // smaller
	    // element in q
