...
public class RemoteSequence {/*
			      * Given the English alphabet, 'a' through 'z'
			      * (lowercase), and an imaginary onscreen keyboard
			      * with the letters laid out in 6 rows and 5
			      * columns: a b c d e f g h i j k l m n o p q r s t
			      * u v w x y z Using a remote control - (up - 'u',
			      * down 'd', left 'l', right 'r' and enter '!'),
			      * write a function that given a word will produce
			      * the sequence of key presses required to type out
			      * the word on the onscreen keyboard. The function
